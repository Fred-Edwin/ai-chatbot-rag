  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 2.5C4 1.11929 5.11929 0 6.5 0H14C14.5523 0 15 0.447715 15 1V11C15 11.5523 14.5523 12 14 12H6.5C5.94772 12 5.5 12.4477 5.5 13C5.5 13.5523 5.94772 14 6.5 14H13.25V12.25H14.75V14V15.25V16H14.75H13.25H6.5C4.567 16 3 14.433 3 12.5V2.5C3 2.5 4 2.5 4 2.5ZM4 11.0858C4.16168 11.0299 4.33123 11 4.5 11H13.5V1.5H6.5C5.94772 1.5 5.5 1.94772 5.5 2.5V10.7C5.5 10.7621 5.48017 10.8192 5.44446 10.8658C5.40875 10.9125 5.35978 10.9455 5.30386 10.9598C5.24794 10.9741 5.18868 10.9691 5.13604 10.9457C5.0834 10.9222 5.04078 10.8818 5.01461 10.8307C4.95 10.6958 4.50826 10.8925 4.16168 11.0858H4Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3.5 0C2.67157 0 2 0.671573 2 1.5V14.5C2 15.3284 2.67157 16 3.5 16H12.5C13.3284 16 14 15.3284 14 14.5V4.5C14 4.36739 13.9473 4.24021 13.8536 4.14645L10.3536 0.646447C10.2598 0.552678 10.1326 0.5 10 0.5H3.5V0ZM3.5 1.5H9.5V4.5V5H10H12.5V14.5H3.5V1.5ZM10.5 2.20711L11.7929 3.5H10.5V2.20711ZM5 7V8.5H11V7H5ZM5 10V11.5H9V10H5Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14Zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16ZM8.75 4.75V5.5V8V8.75H7.25V8V5.5V4.75H8.75ZM8 11.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14Zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16Zm3.78-9.72-4.53 4.53L4.72 8.28 3.28 9.72l2.5 2.5.53.53.53-.53 5-5-1.06-1.06Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14Zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16ZM8.75 4.25V4V3.25H7.25V4V7.56066L10.4697 10.6803L11.5303 9.61967L8.75 6.93934V4.25Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.5 3V2.5C5.5 1.67157 6.17157 1 7 1H9C9.82843 1 10.5 1.67157 10.5 2.5V3H12.5H14V4.5H12.5V13.5C12.5 14.3284 11.8284 15 11 15H5C4.17157 15 3.5 14.3284 3.5 13.5V4.5H2V3H3.5H5.5ZM7 2.5H9V3H7V2.5ZM5 4.5V13.5H11V4.5H5ZM6.5 6.5V12H8V6.5H6.5ZM9.5 6.5V12H11V6.5H9.5Z"
        fill="currentColor"
      />
    </svg>
  );
