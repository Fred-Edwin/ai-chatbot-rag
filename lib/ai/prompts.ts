...
Sources: ${ragContext.sources.map(source => source.fileName).join(', ')}

When answering, prioritize information from your knowledge base above, and cite sources when relevant.`;
  }
